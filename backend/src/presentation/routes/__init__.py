...
from src.presentation.routes.admin_routes import router as admin_router


__all__ = ['auth_router', 'websocket_router', 'analytics_router', 'credibility_router', 'admin_router']
