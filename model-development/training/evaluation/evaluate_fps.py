...
if __name__ == '__main__':
    ...
    MODEL_TO_EVALUATE = 'training/training_runs/exp002_yolov8s_baseline/weights/best.pt'
    
    # Define the path to the video file for the performance test.
    VIDEO_FOR_TEST = 'test-data/val_video_01.mp4' # Ensure this file exists.

    # (Optional) Specify a path to save the output video with detections.
    # Set to `None` to disable video saving.
    OUTPUT_VIDEO_NAME = 'evaluation_results/yolov8s_output.avi'
