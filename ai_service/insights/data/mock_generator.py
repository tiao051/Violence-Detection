...
class ViolenceEventGenerator:
    ...
    # Default camera configuration: (camera_id, camera_name, location, weight)
    # Weight determines relative frequency of events (higher = more events)
    DEFAULT_CAMERAS = [
        ("cam1", "Front Gate", "Entrance", 2.0),
        ("cam2", "Back Yard", "Rear", 1.5),
        ("cam3", "Parking Lot", "Parking", 3.0),  # Hotspot
        ("cam4", "Main Hall", "Interior", 1.0),
        ("cam5", "Side Entrance", "Side", 1.2),
    ]
    ...
    def generate_event(
        ...
        """
        Generate a single mock violence event.
        ...
        camera_id, camera_name, location, _ = camera
        ...
        return ViolenceEvent(
            ...
            status=random.choice(["new", "viewed", "resolved"]),
    ...
    def generate(
        ...
        """
        Generate multiple mock violence events.
        ...
        events = [
            self.generate_event(start_date, end_date, user_id)
